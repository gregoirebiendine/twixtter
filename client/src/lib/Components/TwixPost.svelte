        ...
        <div>
            ...
            <div class="mt-2 flex flex-row">
                <button class="btn-twix-infos">
                    <svg class="w-[16px] text-twixtter-gray fill-current" viewBox="0 0 24 24" aria-hidden="true">
